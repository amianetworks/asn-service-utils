...
identity_args=(
    --asn-service-api-version 26.10.2
    --asn-runtime-version 26.10.10
    --go-version 1.26.3
...
assert_contains build/Manifest.yaml 'asn_service_api_version: "26.10.2"'
assert_contains build/Manifest.yaml 'asn_runtime_version: "26.10.10"'
