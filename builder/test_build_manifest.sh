...
identity_args=(
    --asn-service-api-version 26.9.0
    --asn-runtime-version 26.9.0
    --go-version 1.26.3
...
assert_contains build/Manifest.yaml 'asn_service_api_version: "26.9.0"'
assert_contains build/Manifest.yaml 'asn_runtime_version: "26.9.0"'
