...
identity_args=(
    --asn-service-api-version 26.7.5
    --asn-version 26.7.5
    --dep-version-asn 26.7.5
    --go-version 1.26.3
...
assert_contains build/Manifest.yaml 'asn_service_api_version: "26.7.5"'
assert_contains build/Manifest.yaml 'asn_version: "26.7.5"'
...
assert_contains build/Manifest.yaml 'asn_service_api_version: "26.7.5"'
assert_contains build/Manifest.yaml 'asn_version: "26.7.5"'
assert_contains build/Manifest.yaml 'dep_version_asn: "26.7.5"'
