...
replace asn.amiasys.com/asn-service-api/v26 => github.com/amianetworks/asn-service-api/v26 v26.8.1

require (
	asn.amiasys.com/asn-service-api/v26 v26.8.1
	github.com/amianetworks/am.drivers.sapphire.iam/v26 v26.8.0
